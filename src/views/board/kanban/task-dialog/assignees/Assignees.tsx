    ...
    <div className="flex flex-wrap gap-2">
      {assignees.map((assignee) => (
        <div
          key={assignee._id}
          tabIndex={0}
          className="group flex items-center gap-1.5 rounded-l-xl rounded-r-lg transition-colors focus:bg-white/[0.03]"
        >
      ...
      <AddAssigneeButton taskId={taskId} assignees={assignees} />
    </div>
  );
}
