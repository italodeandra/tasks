...
function Dialog(_a) {
    var children = _a.children, title = _a.title, description = _a.description, open = _a.open, onOpenChange = _a.onOpenChange, contentClassName = _a.contentClassName, contentOverflowClassName = _a.contentOverflowClassName;
    return ((0, jsx_runtime_1.jsx)(RDialog.Root, { open: open, onOpenChange: onOpenChange, children: (0, jsx_runtime_1.jsx)(RDialog.Portal, { children: (0, jsx_runtime_1.jsx)(RDialog.Overlay, { className: (0, clsx_1.default)("ui-dialog-overlay", "z-20 bg-black/50 fixed inset-0 flex items-center justify-center", "data-[state=open]:animate-slideUpAndFade data-[state=closed]:animate-fadeOut will-change-[opacity,transform]"), children: (0, jsx_runtime_1.jsx)(RDialog.Content, { className: (0, clsx_1.default)(Modal_classNames_1.modalContentClassName, "ui-dialog-content", "focus:outline-none relative p-0", contentClassName), children: (0, jsx_runtime_1.jsxs)("div", { className: (0, clsx_1.default)("flex flex-col gap-3 p-4 max-h-[85vh] w-[90vw] max-w-[450px] overflow-auto", contentOverflowClassName), children: [title && ((0, jsx_runtime_1.jsx)(RDialog.Title, { className: (0, clsx_1.default)("ui-dialog-title", "text-zinc-900 dark:text-zinc-50 text-lg font-medium -mb-1"), children: title })), description && ((0, jsx_runtime_1.jsx)(RDialog.Description, { className: (0, clsx_1.default)("ui-dialog-description", "text-zinc-700 dark:text-zinc-300"), children: description })), children, (0, jsx_runtime_1.jsx)(RDialog.Close, { asChild: true, children: (0, jsx_runtime_1.jsx)(Button_1.default, { className: (0, clsx_1.default)("ui-dialog-close-button", "absolute top-1 right-1"), "aria-label": "Close", variant: "text", icon: true, size: "sm", children: (0, jsx_runtime_1.jsx)(solid_1.XMarkIcon, {}) }) })] }) }) }) }) }));
}
