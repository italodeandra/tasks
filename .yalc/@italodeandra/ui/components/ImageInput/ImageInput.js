...
function ImageInput(_a, ref) {
    var _b = _a.icon, icon = _b === void 0 ? defaultIcon : _b, _c = _a.uploadAFileText, uploadAFileText = _c === void 0 ? "Upload an image" : _c, _d = _a.allowedFileTypes, allowedFileTypes = _d === void 0 ? [".png", ".jpg"] : _d, props = __rest(_a, ["icon", "uploadAFileText", "allowedFileTypes"]);
    return ((0, jsx_runtime_1.jsx)(FileInput_1.default, __assign({ ref: ref }, props, { icon: icon, uploadAFileText: uploadAFileText, allowedFileTypes: allowedFileTypes })));
}
