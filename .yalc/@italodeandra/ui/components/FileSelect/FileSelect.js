...
function FileSelect(_a, ref) {
    ...
    var _g = __read((0, react_dnd_1.useDrop)(function () { return ({
    ...
    }); }), 2), _h = _g[0], canDrop = _h.canDrop, isOver = _h.isOver, drop = _g[1];
    return ((0, jsx_runtime_1.jsx)("div", __assign({ ref: drop, className: (0, clsx_1.default)("flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6 dark:border-gray-700", className, {
        ...
        }) }, { children: !canDrop ? ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "relative flex flex-col items-center justify-center space-y-1 text-center" }, { children: [(0, jsx_runtime_1.jsx)("svg", __assign({ className: "mx-auto h-12 w-12 text-gray-400", stroke: "currentColor", fill: "none", viewBox: "0 0 48 48", "aria-hidden": "true" }, { children: (0, jsx_runtime_1.jsx)("path", { d: "M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" }) })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "text-sm" }, { children: [(0, jsx_runtime_1.jsxs)("label", __assign({ htmlFor: id, className: "relative cursor-pointer rounded-md font-medium text-primary-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2 hover:text-primary-500 dark:ring-offset-slate-900" }, { children: [(0, jsx_runtime_1.jsx)("span", { children: uploadAFileText }), (0, jsx_runtime_1.jsx)("input", { id: id, name: id, type: "file", className: "sr-only", accept: allowedFileTypes === null || allowedFileTypes === void 0 ? void 0 : allowedFileTypes.join(","), onChange: handleFileBrowse, multiple: limit !== 1, ref: ref })] })), (0, jsx_runtime_1.jsx)("span", __assign({ className: "pl-1" }, { children: orDragAndDropText }))] })), (0, jsx_runtime_1.jsxs)("p", __assign({ className: "text-xs text-gray-500" }, { children: [allowedFileTypes
