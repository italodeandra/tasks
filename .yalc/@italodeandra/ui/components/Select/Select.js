...
function SelectTrigger(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(RSelect.Trigger, __assign({ asChild: true }, props, { className: className, ref: children ? ref : undefined, children: children || ((0, jsx_runtime_1.jsx)(Button_1.default, { trailing: (0, jsx_runtime_1.jsx)(RSelect.Icon, { children: (0, jsx_runtime_1.jsx)(solid_1.ChevronDownIcon, {}) }), ref: ref, children: (0, jsx_runtime_1.jsx)(RSelect.Value, { placeholder: placeholder }) })) })));
}
...
var Select = {
    Root: RSelect.Root,
    Item: SelectItem,
    Trigger: (0, react_1.forwardRef)(SelectTrigger),
