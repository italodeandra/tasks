...
function Menu(_a) {
    var className = _a.className, iconClassName = _a.iconClassName, _b = _a.position, position = _b === void 0 ? "right" : _b, children = _a.children, label = _a.label, button = _a.button;
    return ((0, jsx_runtime_1.jsxs)(react_2.Menu, __assign({ as: "div", className: (0, clsx_1.default)("relative inline-block text-left", className) }, { children: [(0, jsx_runtime_1.jsx)("div", { children: button ? ((0, jsx_runtime_1.jsx)(react_2.Menu.Button, __assign({ as: react_1.Fragment }, { children: button }))) : ((0, jsx_runtime_1.jsx)(react_2.Menu.Button, __assign({ as: Button_1.default, className: "flex w-full", trailingIcon: (0, jsx_runtime_1.jsx)(solid_1.ChevronDownIcon, { className: iconClassName }) }, { children: label }))) }), (0, jsx_runtime_1.jsx)(react_2.Transition, __assign({ as: react_1.Fragment, enter: "transition ease-out duration-100", enterFrom: "transform opacity-0 scale-95", enterTo: "transform opacity-100 scale-100", leave: "transition ease-in duration-75", leaveFrom: "transform opacity-100 scale-100", leaveTo: "transform opacity-0 scale-95" }, { children: (0, jsx_runtime_1.jsx)(react_2.Menu.Items, __assign({ className: (0, clsx_1.default)(exports.defaultMenuItemsClassName, "absolute mt-2 min-w-[14rem]", {
