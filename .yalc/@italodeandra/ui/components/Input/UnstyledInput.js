...
function UnstyledInput(_a, ref) {
    var _b, _c;
    var id = _a.id, label = _a.label, className = _a.className, inputClassName = _a.inputClassName, labelClassName = _a.labelClassName, helpTextClassName = _a.helpTextClassName, trailingClassName = _a.trailingClassName, trailingInputClassName = _a.trailingInputClassName, leadingClassName = _a.leadingClassName, leadingInputClassName = _a.leadingInputClassName, helpText = _a.helpText, _d = _a.type, type = _d === void 0 ? "text" : _d, leading = _a.leading, trailing = _a.trailing, select = _a.select, children = _a.children, as = _a.as, innerClassName = _a.innerClassName, value = _a.value, props = __rest(_a, ["id", "label", "className", "inputClassName", "labelClassName", "helpTextClassName", "trailingClassName", "trailingInputClassName", "leadingClassName", "leadingInputClassName", "helpText", "type", "leading", "trailing", "select", "children", "as", "innerClassName", "value"]);
    var innerId = (0, react_1.useId)();
    id = id || innerId;
    var Component = as || (select ? "select" : "input");
    inputClassName = (0, clsx_1.default)(inputClassName, leadingInputClassName && (_b = {},
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: className, children: [label && ((0, jsx_runtime_1.jsx)("label", { htmlFor: id, className: labelClassName, children: label })), (0, jsx_runtime_1.jsxs)("div", { style: { position: "relative" }, className: innerClassName, children: [leading && (0, jsx_runtime_1.jsx)("div", { className: leadingClassName, children: leading }), (0, jsx_runtime_1.jsx)(Component
                    ...
                    , __assign({}, props, { className: inputClassName, id: id, type: type, ref: ref, value: value, children: select ? children : undefined })), trailing && (0, jsx_runtime_1.jsx)("div", { className: trailingClassName, children: trailing })] }), helpText && (0, jsx_runtime_1.jsx)("div", { className: helpTextClassName, children: helpText })] }));
}
