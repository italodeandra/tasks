...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        ...
        if (this.state.hasError) {
            ...
            return ((0, jsx_runtime_1.jsx)(Alert_1.default, __assign({ variant: "error", title: this.props.title || "Oops, there was an unexpected error", actions: this.props.tryAgain && ((0, jsx_runtime_1.jsx)(Button_1.default, __assign({ variant: "text", color: "error", onClick: function () { return _this.setState({ hasError: false }); } }, { children: this.props.tryAgain }))) }, { children: this.props.content })));
        }
