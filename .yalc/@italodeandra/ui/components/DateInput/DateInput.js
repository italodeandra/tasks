...
function DateInput(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Input_1.default, __assign({}, props, { ref: realRef, type: "date", pattern: "[0-9]{4}-[0-9]{2}-[0-9]{2}", trailing: !readOnly ? (0, jsx_runtime_1.jsx)(solid_1.CalendarIcon, { className: "w-5" }) : undefined, inputClassName: "!pr-3", readOnly: readOnly })));
}
