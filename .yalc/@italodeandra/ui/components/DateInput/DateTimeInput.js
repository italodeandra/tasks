...
function DateTimeInput(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Input_1.default, __assign({}, props, { ref: realRef, type: "datetime-local", pattern: "[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}", trailing: (0, jsx_runtime_1.jsx)(solid_1.CalendarIcon, { className: "w-5" }), inputClassName: "!pr-3" })));
}
