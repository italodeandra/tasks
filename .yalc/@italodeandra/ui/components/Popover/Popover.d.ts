...
declare function PopoverContentWithRef({ className, sideOffset, children, ...props }: ComponentProps<typeof RPopover.Content>, ref: ForwardedRef<HTMLDivElement>): JSX.Element;
