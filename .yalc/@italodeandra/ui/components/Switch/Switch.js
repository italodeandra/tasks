...
function Switch(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_1.Switch.Group, __assign({ as: "div", className: (0, clsx_1.default)("flex items-center", className) }, { children: [(0, jsx_runtime_1.jsxs)(react_1.Switch, __assign({ checked: checked, onChange: onChange, className: (0, clsx_1.default)({
                ...
                }, "relative inline-flex h-6 w-11 flex-shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:ring-offset-zinc-900", switchClassName), disabled: readOnly }, { children: [srLabel && (0, jsx_runtime_1.jsx)("span", __assign({ className: "sr-only" }, { children: srLabel })), (0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: (0, clsx_1.default)({
                            "translate-x-5": checked,
                            "translate-x-0": !checked,
                        }, "pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out", pointerClassName) })] })), rightLabel && ((0, jsx_runtime_1.jsx)(react_1.Switch.Label, __assign({ as: "span", className: "ml-3" }, { children: (0, jsx_runtime_1.jsx)("span", __assign({ className: "text-sm text-gray-500 dark:text-gray-300" }, { children: rightLabel })) })))] })));
}
