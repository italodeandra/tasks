...
function DataTable(_a) {
    var title = _a.title, subtitle = _a.subtitle, headerContent = _a.headerContent, data = _a.data, _b = _a.idAccessor, idAccessor = _b === void 0 ? "_id" : _b, actions = _a.actions, columns = _a.columns, isLoading = _a.isLoading, _c = _a.noRecords, noRecordsText = _c === void 0 ? "No records" : _c, onRowClick = _a.onRowClick, rowWrapper = _a.rowWrapper, pagination = _a.pagination, _d = _a.currentPage, currentPage = _d === void 0 ? 0 : _d, onChangePage = _a.onChangePage, totalItems = _a.totalItems, _e = _a.itemsPerPage, itemsPerPage = _e === void 0 ? 0 : _e, className = _a.className, autoHeight = _a.autoHeight, onChangeSort = _a.onChangeSort, _f = _a.sort, defaultSort = _f === void 0 ? [] : _f;
