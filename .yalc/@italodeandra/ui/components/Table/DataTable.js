...
function DataTable(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Stack_1.default, __assign({ className: className }, { children: [(title || subtitle || headerContent) && ((0, jsx_runtime_1.jsx)(Table_1.default.Header, __assign({ title: title, subtitle: subtitle }, { children: headerContent }))), (0, jsx_runtime_1.jsxs)(Table_1.default, __assign({ className: "relative" }, { children: [(0, jsx_runtime_1.jsxs)(Table_1.default.Head, { children: [(0, jsx_runtime_1.jsxs)(Table_1.default.Row, { children: [columns.map(function (column, i) { return ((0, jsx_runtime_1.jsx)(Table_1.default.Cell, { children: column.title }, column.id ||
                                        (typeof column.title === "string" ? column.title : i))); }), actions && (0, jsx_runtime_1.jsx)(Table_1.default.Cell, {})] }), isLoading && ((0, jsx_runtime_1.jsx)("tr", __assign({ className: "absolute top-3.5 right-3 rounded-full bg-gray-50/50 dark:bg-zinc-800/50" }, { children: (0, jsx_runtime_1.jsx)("td", { children: (0, jsx_runtime_1.jsx)(Loading_1.default, {}) }) })))] }), (0, jsx_runtime_1.jsxs)(Table_1.default.Body, { children: [data === null || data === void 0 ? void 0 : data.map(function (item) {
                                ...
                                return ((0, jsx_runtime_1.jsx)(RowComponent, __assign({}, (RowComponent !== react_1.Fragment
                                    ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                        { item: item }
                                    : {}), { children: (0, jsx_runtime_1.jsxs)(Table_1.default.Row, __assign({ onClick: handleRowClick(item) }, { children: [columns.map(function (column, i) { return ((0, jsx_runtime_1.jsxs)(Table_1.default.Cell, { children: [column.accessor && item[column.accessor], !column.accessor && column.render && column.render(item)] }, column.id ||
                                                (typeof column.title === "string" ? column.title : i))); }), actions && ((0, jsx_runtime_1.jsx)(Table_1.default.Cell, __assign({ actions: true }, { children: actions.map(function (action, i) {
                                                    var _a;
                                                    var ActionComponent = action.wrapper || react_1.Fragment;
                                                    return ((0, jsx_runtime_1.jsx)(ActionComponent, __assign({ item: item }, { children: (0, jsx_runtime_1.jsx)(Table_1.default.ActionButton, __assign({ title: action.title, onClick: function () { var _a; return (_a = action.onClick) === null || _a === void 0 ? void 0 : _a.call(action, item); }, href: typeof action.href === "function"
                                                                ? (_a = action.href) === null || _a === void 0 ? void 0 : _a.call(action, item)
                                                                : action.href }, { children: action.icon })) }), i));
                                                }) })))] })) }), item[idAccessor]));
                            }), isLoading && !(data === null || data === void 0 ? void 0 : data.length) && ((0, jsx_runtime_1.jsxs)(Table_1.default.Row, { children: [columns.map(function (column, i) { return ((0, jsx_runtime_1.jsx)(Table_1.default.Cell, { children: (0, jsx_runtime_1.jsx)(Skeleton_1.Skeleton, { className: "h-2" }) }, column.id ||
