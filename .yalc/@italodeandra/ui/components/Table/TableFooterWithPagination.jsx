...
export default function TableFooterWithPagination({ itemsPerPage, totalItems, currentPage, onChangePage, previousText = "Previous", nextText = "Next", showingText = "Showing", toText = "to", ofText = "of", resultsText = "results", }) {
    const pageCount = totalItems !== undefined && itemsPerPage !== undefined
    ...
    return (<TableFooter>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          <Pagination itemsPerPage={itemsPerPage} totalItems={totalItems} currentPage={currentPage} onChangePage={onChangePage}/>
        </div>
      </div>
    </TableFooter>);
}
