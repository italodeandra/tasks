...
function Code(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: (0, clsx_1.default)("group relative", className) }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "prose max-w-none" }, { children: (0, jsx_runtime_1.jsx)(prism_react_renderer_1.default, __assign({}, prism_react_renderer_1.defaultProps, { code: children.trimEnd(), language: language, theme: undefined }, { children: function (_a) {
