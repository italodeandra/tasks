...
function Badge(_a) {
    var _b = _a.color, color = _b === void 0 ? "primary" : _b, _c = _a.size, size = _c === void 0 ? "md" : _c, className = _a.className, children = _a.children, onActionClick = _a.onActionClick, href = _a.href, shallow = _a.shallow;
