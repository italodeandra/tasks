...
exports.invalidate_authPanelUserList = exports.prefetch_authPanelUserList = exports.useAuthPanelUserList = void 0;
...
exports.default = authPanelUserListHandler;
var queryKey = "/api/auth/panel/user/list";
var useAuthPanelUserList = function (args) {
...
var prefetch_authPanelUserList = function (queryClient) {
    ...
    return queryClient.prefetchQuery([queryKey, args[0].search, args[0].sort, args[0].sortDirection], function () { return authPanelUserListHandler.apply(void 0, args); });
};
exports.prefetch_authPanelUserList = prefetch_authPanelUserList;
var invalidate_authPanelUserList = function (queryClient) {
    return queryClient.invalidateQueries([queryKey]);
};
exports.invalidate_authPanelUserList = invalidate_authPanelUserList;
