...
export default function authPanelUserUpdateHandler(args: Jsonify<Pick<IUser, "_id" | "name" | "email" | "type" | "customData">>, req: NextApiRequest, res: NextApiResponse, { connectDb, multitenantMode }: AuthConfig): Promise<{
